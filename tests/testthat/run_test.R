...
source("R/algorithms/KMeansVariablesR6.R") # Contient KMeansVariablesR6
source("R/algorithms/HACVariablesR6.R") # Contient HACVariablesR6
...
data_to_cluster <- read_excel("tests/testthat/jobrate.xlsx")
